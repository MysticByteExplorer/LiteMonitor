...
namespace LiteMonitor
{
    public class Settings
    {
        ...
        // ====== FPS屏幕显示设置 ======
        public bool ShowFpsOnScreen { get; set; } = false;
        public int FpsScreenPosition { get; set; } = 2; // 0=TopLeft, 1=TopCenter, 2=TopRight
        public float FpsScreenFontSize { get; set; } = 24f;
        public string FpsScreenFormat { get; set; } = "FPS: $[fps]";
        public string FpsScreenColor { get; set; } = "#FF0000"; // FPS显示颜色（十六进制格式）
        ...
        private void InitDefaultItems()
        {
            MonitorItems = new List<MonitorItemConfig>
            {
                ...
                new MonitorItemConfig { Key = "FPS.Current", SortIndex = 60, VisibleInPanel = true, VisibleInTaskbar = true }
            };
        }
    }
